 ...
 * @LastEditors: Panda
 * @LastEditTime: 2024-02-29 14:16:13
 * @FilePath: \shop-admind:\vueworkspace\RuoYi-Vue3\src\utils\request.ts
 */
  ...
  return service
    ...
    .then(async (data: any) => {
      ...
      if (isBlob) {
        ...
        const errMsg = (errorCode as any)[rspObj.code] || rspObj.msg || errorCode['default']
